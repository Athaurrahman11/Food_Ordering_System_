<header class="sticky top-0 z-50 bg-white/80 backdrop-blur-lg px-6 py-4 lg:px-20 border-b border-slate-100/50 flex justify-between items-center transition-all duration-300">
    ...
    <nav class="hidden md:flex items-center gap-10 text-sm font-bold">
        <a href="{{ route('home') }}" class="text-[#f48c25] relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-full after:h-0.5 after:bg-[#f48c25] after:rounded-full">Home</a>
    ...
    <div class="flex items-center gap-6">
        ...
        <a href="{{ route('shop') }}" class="bg-[#f48c25] text-white px-6 py-2.5 rounded-2xl font-bold text-sm flex items-center gap-2 shadow-xl shadow-[#f48c25]/20 hover:scale-[1.03] active:scale-[0.97] transition-all">
