...
@section('content')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Function to handle fetching and updating grid
                ...
                try {
                    const response = await fetch(url, {
                        headers: {
                            ...
                            'Accept': 'application/json' // Explicitly ask for JSON/Partial
                        }
                    });
                    ...
                    // Scroll to top of grid on mobile or if deep down
            ...
            // Category Links (Sidebar sidebar links)
            ...
            categoryLinks.forEach(link => {
                link.addEventListener('click', function(e) {
                    ...
                    categoryLinks.forEach(l => {
                        ...
                        // Fix Icon Div (Reset to inactive style)
                    ...
                    // Fix Icon Div (Set to active style)
            ...
            // Pagination Links (Delegate event as they are replaced dynamically)
