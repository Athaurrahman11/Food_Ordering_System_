...
<a class="flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg text-sm font-bold hover:bg-primary/90 transition-all shadow-lg shadow-primary/20 cursor-pointer" href="{{ uri('add_menu') }}">
...
<a href="{{ $menuitem->id }}" class="material-symbols-outlined text-sm filled-icon">edit</a>
</button>
...
<a href="{{ $menuitem->id }}" class="material-symbols-outlined text-sm filled-icon" >delete</a>
</button>
</div>
