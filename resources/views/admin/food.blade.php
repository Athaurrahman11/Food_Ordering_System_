    ...
    <div class="flex-1 overflow-y-auto p-8">
        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden">
                <form action="{{ url('store_food') }}" class="p-8 space-y-8" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <input class="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-primary focus:border-transparent text-sm @error('name') border-red-500 @enderror" placeholder="e.g., Spicy Tuna Roll" type="text" name="name" required />
                            @error('name')
                                <p class="text-red-500 text-xs mt-1 font-bold">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <select class="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-2.5 appearance-none focus:ring-2 focus:ring-primary focus:border-transparent text-sm @error('menu_id') border-red-500 @enderror" name="menu_id" required>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input class="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg pl-8 pr-4 py-2.5 focus:ring-2 focus:ring-primary focus:border-transparent text-sm" placeholder="0.00" step="0.01" type="number" name="price" required />
                            </div>
                        </div>

                        <div class="md:col-span-2 space-y-2">
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Quantity / Stock</label>
                            <input class="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-primary focus:border-transparent text-sm" placeholder="0" type="number" name="stock" required />
                        </div>
                    </div>
